function S = jp_spm5_normalizestructural(S, subnum)
%JP_SPM5_NORMALIZESTRUCTURAL Normalizes subject's structural image.
%
% S = JP_SPM5_NORMALIZESTRUCTURAL(S, SUBNUM) normalizes the structural
