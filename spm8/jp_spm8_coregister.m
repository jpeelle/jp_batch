function S = jp_spm8_coregister(S, subnum)
%JP_SPM8_COREGISTER Coregister images using SPM8.
%
% S = JP_SPM8_COREGISTER(S, SUBNUM) will coregister images for
% subject number SUBNUM from an S structure (see JP_INIT).
%
% Options in S.cfg.jp_spm8_coregister include:
%   prefix  Before 'mean' in the mean functional
%
% JP_SPM8_COREGISTER tries to coregister the mean functional
